...
if __name__ == "__main__":
    ...
    search_parameters['SklearnLogReg'] = {'C' : ( 10**-5, 3*10**-5, 10**-4, 3*10**-4), 'solver' : ('newton-cg', 'lbfgs', 'liblinear', 'sag'), 'penalty': ('l1', 'l2'), 'dual': (False, True), 'fit_intercept': (True, False), 'intercept_scaling': (1, 2, 3), 'max_iter': (100, 200, 400, 800, 1000)}
